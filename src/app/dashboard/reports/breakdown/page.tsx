...
export default function HoursBreakdownPage() {
  ...
  const handleExportExcel = () => {
    ...
    link.href = url;
    link.setAttribute("download", `hours_breakdown_report_${appliedStartDate}_to_${appliedEndDate}.xlsx`);
                ...
                <table className="w-full border-collapse border border-gray-300">
                  <thead className="text-sm font-bold uppercase tracking-wider text-purple-700 bg-purple-50 sticky top-0 z-20">
                    ...
                    <tr className="border-b border-purple-200 bg-purple-50">
                      ...
                      <th rowSpan={3} className="px-4 py-3 text-center border-r border-purple-200 font-semibold w-24 bg-purple-50 sticky top-0 z-30">Date</th>
