  ...
  return (
    <ContextMenu>
          ...
          <CardContent className="p-5 flex flex-col gap-3">
            ...
            <div className="pt-2 border-t border-gray-100 flex flex-col gap-1.5 mt-auto">
              ...
              <div className="flex justify-between items-center text-base">
                ...
                <span className="font-mono text-gray-700 bg-gray-100 px-1.5 py-0.5 rounded text-sm">{user.employeeCode}</span>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <ContextMenuContent className="w-52 p-1">
        <ContextMenuItem onClick={() => router.push(`/dashboard/users/missing-entries?user=${user._id}`)} className="flex items-center gap-2 py-1.5 text-sm text-gray-700">
          <Filter className="w-4 h-4 text-gray-500" />
          <span>Missing Entries</span>
        </ContextMenuItem>
        <ContextMenuSeparator className="my-1" />
        <ContextMenuItem onClick={() => router.push(`/dashboard/users/${user._id}/edit`)} className="flex items-center gap-2 py-1.5 text-sm text-gray-700">
          <Pencil className="w-4 h-4 text-gray-500" />
          <span>Edit User</span>
        </ContextMenuItem>
        <ContextMenuSeparator className="my-1" />
        <ContextMenuItem onClick={() => handleToggleActive(user)} className="flex items-center gap-2 py-1.5 text-sm text-gray-700">
          {user.deactivateDate ? (
        ...
        <ContextMenuSeparator className="my-1" />
        <ContextMenuItem onClick={() => handleDelete(user)} className="flex items-center gap-2 py-1.5 text-sm text-red-600 hover:text-red-700 focus:text-red-700">
    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 w-full">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-base text-gray-500 mt-1">Manage your team members and their account permissions here.</p>
        </div>
            ...
            <div className="flex flex-col">
              <div className="bg-gradient-to-br from-primary-50 to-primary-100 p-6 border-b border-primary-100/50">
                <DialogHeader>
                  ...
                  <DialogDescription className="text-base text-gray-600 font-medium mt-1">
                    {selectedUser.email}
                  </DialogDescription>
                </DialogHeader>
              </div>
              ...
              <div className="p-6 space-y-4 bg-white">
                <div className="grid grid-cols-2 gap-y-4 gap-x-6">
                  <div>
                    <p className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-1">Employee Code</p>
                    <p className="font-mono text-gray-900 font-medium bg-gray-50 px-2 py-1 rounded inline-block text-base">
                      {selectedUser.employeeCode}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-1">Role</p>
                    <span className={`inline-flex items-center px-2 py-0.5 rounded-md text-sm font-medium border ${getRoleBadgeColor(typeof selectedUser.role === 'object' ? selectedUser.role.name : selectedUser.role)}`}>
                      {typeof selectedUser.role === 'object' ? selectedUser.role.name : selectedUser.role}
                    </span>
                  </div>
                  <div className="col-span-2">
                    <p className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-1">Department</p>
