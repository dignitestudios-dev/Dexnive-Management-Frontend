...
export function ProjectForm({ initialData }: ProjectFormProps) {
  ...
  const handleSave = () => {
    ...
    if (initialData) {
      // For updates, do not send activateFirstStage or code
          ...
          <div className="space-y-1">
            ...
            {initialData ? (
              <Input 
                value={formData.code} 
                disabled
                className="h-9 bg-gray-100 uppercase cursor-not-allowed text-gray-500"
              />
            ) : (
              <div className="h-9 px-3 border border-gray-200 rounded-md bg-gray-100/80 flex items-center text-xs text-gray-500 italic">
